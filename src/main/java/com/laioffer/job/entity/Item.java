...
@JsonIgnoreProperties(ignoreUnknown = true) // if contains unknown field, here is type, please mark as ignorable.
@JsonInclude(JsonInclude.Include.NON_NULL)  // if contains null value, such as keywords, then that null will not be shown
public class Item {
    private String id;
